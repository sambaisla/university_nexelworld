...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <link href="{{URL::asset('css/css/css/style.css')}}" rel="stylesheet">
    ...
    <div class="row justify-content-center loginform">
        <div class="col-md-8">
            <div class="card" style="background-color:#a04655;">
                <b><div class="card-header text-center" style="font-size:25px;color:#ffffff;">{{ __('Reset Password') }}</div></b>
                ...
                <div class="card-body" style="background-color:#EBD199; font-size:18px;">
                    ...
                    <form method="POST" action="{{ route('email_for_password_change') }}">
                        @csrf
